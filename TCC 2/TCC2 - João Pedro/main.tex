...
\input{./PreTexto/entradas-siglas}%% Entradas da lista de abreviaturas e siglas - Comente para remover este item
\input{./PosTexto/entradas-glossario}%% Entradas do glossário - Comente para remover este item
...
\include{./capitulos/cap-algoritmos}
...
\arquivosdereferencias{%% Arquivos bibtex sem a extensão .bib e separados por vírgula - Não comente esta linha
  ...
  bibliografia%% Arquivo de referências - Comente para remover este item
