...
\author{João Pedro Rodrigues Leite}  % Seu nome
\authorbib{Leite, João Pedro} % Seu nome para referência bibliográfica (Sobrenome, Nome)
\title{Segurança em comunicações pós-quânticas} % Título do trabalho
\titleen{Post-Quantum Communication Security} % Título traduzido para inglês
